...
public abstract class GenericMapperKeyComparer<K> implements IMapperKeyComparerWrapper<K>
{
	private K mValue;
	
	protected GenericMapperKeyComparer(K pValue)
	{
		mValue = pValue;
	}
	...
	@Override
	public IMapperKeyComparerWrapper<K> setValue(K pValue)
	{
		mValue = pValue;
		return this;
	}
